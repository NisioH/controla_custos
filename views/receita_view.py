...
#         self.carregar_dropdown_ingredientes()
#
#     def carregar_dropdown_ingredientes(self):
#     # 1. Busca os dados atualizados do banco
#         ingredientes = self.db.ler_ingredientes()
#
#         # 2. Limpa as opções que estavam lá antes
...
#             )
#
#         # 4. ESSENCIAL: Avisa o Flet para redesenhar o Dropdown na tela
#         self.update()
#
#     def adicionar_item_lista(self, e):
#         if not self.sel_ingrediente.options or not self.txt_quantidade.value:
...
#         })
#
#         self.coluna_itens_visivel.controls.appendd(
#             ft.Container(
#                 content=ft.Row([
...
#
#         try:
#             self.db.salvar_receita(nome, float(rendimento), self.lista_itens_temporaria)
...
class ReceitaView(ft.Column):
    ...
    def carregar_dados(self): # Nome alterado para bater com o main.py
        # 1. Busca os dados atualizados do banco
        ingredientes = self.db.ler_ingredientes()
    ...
    def adicionar_item_lista(self, e):
        ...
        # Corrigido de appendd para append
